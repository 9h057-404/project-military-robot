...
<head>
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/Karthikg09/military-robot@main/sensorCode/style3.css">
...
<body>
    <section>
        ...
        <div class="login">
            ...
            <audio id="alert-sound" src="https://cdn.jsdelivr.net/gh/Karthikg09/military-robot@main/sensorCode/audio.mp3"></audio>
            <!-- pir code end  -->
            <br>
    ...
    <script src="https://cdn.jsdelivr.net/gh/Karthikg09/military-robot@main/sensorCode/app4.js"></script>
</body>
</html>
)=====";